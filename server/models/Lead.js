...
const LeadSchema = new mongoose.Schema({
  ...
  status: { type: String, default: 'pending', enum: ['pending', 'queued', 'contacted', 'interested', 'not_interested', 'completed', 'processing', 'no_whatsapp', 'failed', 'check_failed', 'paused', 'discarded'] },
