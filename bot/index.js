  ...
  async sendMessageSequence(lead) {
    ...
    try {
      ...
      if (!quickCheck.valid) {
        ...
        // En vez de quemar el lead, intentamos enviar un mensaje de prueba.
        ...
        try {
          ...
          if (trialResult && trialResult.id) {
            // El mensaje se envió — el número ES válido (falso negativo de quickVerify)
            ...
            // Nota: el '.' ya se envió, continuamos con el flujo normal.
            // El primer mensaje real se enviará normalmente.
          }
        } catch (trialError) {
          // Si el envío falla, ahí sí el número NO tiene WhatsApp
